...
export const metadata: Metadata = {
  title: "关于小保伟", description: "了解插画创作者小保伟。",
  openGraph: { title: "关于小保伟", description: "插画、手写诗、绘本与动画创作者。", url: "https://www.xiaobaowei.com/about", images: [image] },
  twitter: { card: "summary_large_image", title: "关于小保伟", description: "插画、手写诗、绘本与动画创作者。", images: [image] },
};

export default function AboutPage() {
  return <main id="top"><SiteHeader active="/about" /><section className="about about-page" aria-labelledby="about-title">
    <p className="about-label">05 · About</p><div><h1 id="about-title">小保伟是一位插画创作者。</h1>
